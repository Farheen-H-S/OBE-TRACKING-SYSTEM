...
<<<<<<< HEAD:frontend/webapp/src/pages/admin/Updateuser.js
import Header from "../../components/header/Header";
import Sidebar from "../../components/sidebar/Sidebar";
=======
import { FaUserEdit } from 'react-icons/fa';
>>>>>>> bst-login-fix:frontend/webapp/src/Updateuser.js
    ...
    <div className="input-group">
      ...
      />
                ...
                <div className="row mb-3 align-items-center">
                  ...
                  <div className="col-sm-3">
                    <input type="text" className="form-control" defaultValue="2025" />
                  </div>
                </div>
                ...
                <div className="row mb-3 align-items-center">
                  ...
                  <div className="col-sm-3">
                    <input type="text" className="form-control" defaultValue="01/02/2022" />
                  </div>
                </div>
                ...
                <div className="row mb-3 align-items-center">
                  ...
                  <div className="col-sm-4">
                    <input type="text" className="form-control" defaultValue="312023046" />
                  </div>
                </div>
                ...
                <div className="row mb-3 align-items-center">
                  ...
                  <div className="col-sm-4">
                    <input type="password" className="form-control" defaultValue="3ji200" />
                  </div>
                </div>
                ...
                <div className="row mb-3 align-items-center">
                  ...
                  <div className="col-sm-9">
                    <button type="button" className="btn btn-light border">Upload</button>
                  </div>
                </div>
