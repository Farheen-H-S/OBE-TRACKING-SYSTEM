...
class POAttainment(models.Model):
    ...
    gap = models.FloatField(null=True, blank=True, help_text="Target - Normalized")
...
class PSOAttainment(models.Model):
    attainment_id = models.AutoField(primary_key=True)
    pso_id = models.ForeignKey('academics.PSO', on_delete=models.PROTECT, related_name='attainments', db_column='pso_id')
    course_id = models.ForeignKey('academics.Course', on_delete=models.PROTECT, related_name='pso_attainments', db_column='course_id')
