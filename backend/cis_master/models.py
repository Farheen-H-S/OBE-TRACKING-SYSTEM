...
class CISType(models.Model):
    ...
    nature_id = models.ForeignKey(CISNature, on_delete=models.PROTECT, related_name='types', db_column='nature_id')
...
class CISTerm(models.Model):
    ...
    type_id = models.ForeignKey(CISType, on_delete=models.PROTECT, related_name='terms', db_column='type_id')
