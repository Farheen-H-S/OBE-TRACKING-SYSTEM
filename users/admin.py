...
class UserAdmin(admin.ModelAdmin):
    list_display = ('user_id', 'name', 'email', 'role_id', 'is_active')
    list_filter = ('role_id', 'is_active')
    search_fields = ('name', 'email')

@admin.register(Student)
class StudentAdmin(admin.ModelAdmin):
    list_display = ('student_id', 'roll_no', 'name', 'program_id', 'batch_id', 'semester', 'is_active')
...
class FacultyCourseAssignmentAdmin(admin.ModelAdmin):
    list_display = ('assignment_id', 'faculty_id', 'course_id', 'academic_year', 'semester', 'is_active')
