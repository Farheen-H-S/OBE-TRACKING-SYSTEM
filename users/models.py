...
from academics.models import Program, Batch, Course
...
class Student(models.Model):
    ...
    batch_id = models.ForeignKey(Batch, on_delete=models.PROTECT, db_column='batch_id')
...
class FacultyCourseAssignment(models.Model):
    ...
    def __str__(self):
        return f"{self.faculty_id.name} - {self.course_id.course_name} ({self.academic_year})"